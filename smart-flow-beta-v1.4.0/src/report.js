...
export function reportPacket(report){
 if(!report)return null;return{engineVersion:report.engineVersion,generatedAt:report.generatedAt,topSignal:report.topSignal,rankedSignals:report.signals.slice(0,12),divergences:report.divergences,priceAligned:report.aligned,topPremiumBlocks:report.topBlocks.slice(0,12),largestTypeClusters:report.largestTypeClusters,dataQuality:report.dataQuality,priceCoverage:report.priceCoverage,guardrails:[
