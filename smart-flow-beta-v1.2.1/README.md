# Smart Flow Intelligence — Private Beta v1.2.0
...
1. Download the Options Flow CSV from Barchart.
2. Upload the CSV in the beta.
3. Open **Data Audit** first if a score looks suspicious.
